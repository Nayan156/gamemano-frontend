...
//   // Sort state
//   const [sortBy, setSortBy]     = useState(null)       // e.g. 'rating-desc'
//   const [isSortOpen, setSortOpen] = useState(false)
//   const sortRef   = useRef(null)

//   // Fetch products whenever the selected categories change
//   useEffect(() => {
//     setLoading(true)
...
//     ? 'All Products'
//     : 'Category: ' + selectedCategories.map(s => s.replace(/-/g,' ')).join(', ')
...
//                       ${sortBy === opt.value ? 'bg-orange-500 text-white' : 'text-white hover:bg-white/10'}
//                     `}
//                   >
//                     {opt.label}
//                   </button>
